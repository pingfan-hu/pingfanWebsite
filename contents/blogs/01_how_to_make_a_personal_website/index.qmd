...
<a href="https://github.com/pingfan0727/My-Website" class="btn btn-primary" role="button"> GitHub Repo of My Website </a>

<a href="https://github.com" class="btn btn-info" role="button"> GitHub </a> <a href="https://www.namecheap.com" class="btn btn-info" role="button"> Namecheap </a> <a href="https://www.netlify.com" class="btn btn-info" role="button"> Netlify </a>

<a href="https://desktop.github.com" class="btn btn-success" role="button"> GitHub Desktop </a> <a href="https://www.r-project.org" class="btn btn-success" role="button"> R </a> <a href="https://www.rstudio.com/categories/rstudio-ide/" class="btn btn-success" role="button"> RStudio </a> <a href="https://quarto.org" class="btn btn-success" role="button"> Quarto </a>
...
> Hint: If you want to save time, I recommend that you buy domain on [Netlify](https://www.netlify.com) so that you won't need to bother dealing with DNS assignment. However, [Namecheap](https://www.namecheap.com) gives you full service of domain management and DNS customization, and, as it's name indicates, it sells domains a little cheaper.
...
3.  I also used a customized `scss` file called `theme.scss` and another css file called `styles.css`. Both `scss` and `css` files are used to define personal page layout settings. The YAML grammar looks like this (You can see the full YAML codes in the `_quarto.yml` file):
    ...
    Note that there is a `backgroundcolor: "#F8F7F0"` used to set the page background color. The short reason is it gives the best compatibility.
