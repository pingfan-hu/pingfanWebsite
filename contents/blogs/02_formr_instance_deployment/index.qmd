...
-   My user name: `pingfan`
-   My password for the database: `0727` (not for the shell command)
-   Email for the host: [formrcloudgwu\@gmail.com](mailto:formrcloudgwu@gmail.com)
...
6.  **Root Password** - A `root` user will be generated for you upon server creation. This password it for accessing this `root` server. However, better create a real user and avoid using `root`. I'll cover this later.
...
# An absolute path disregard your current path. It is a good way to present instructions.
cd ~/dir_name
```
