...
This blog briefly describes of my approaches of doing research. It contains [Research Methods], [Research Tools], and [Publication & Communication](#publication-communication).
...
3.  **Publication & Communication**: GitHub, Craft Doc, Personal Website, and more.
...
-   The **blue** part on the right is whatever the paper that I am hovering over to (otherwise the main paper which is Dr Helveston's in this case). It shows the paper's title, abstract, and places where you can access it.
...
However, free accounts of Connected Papers only gives you 5 networks per day. If you use it frequently, you might need monthly or annual subscriptions.
...
5.  **Netlify** deploys your site. You may log in using your GitHub credential.
