...
> The CDF of logit model is an S curve. With a visible diminishing return, it is a perfect model for human behavior studies for the purpose of generating a feasible marketing strategy.
...
2.  **Odds** refer to the ratio of the probability of an event occurring to the probability of the event not occurring.
