...
The traditional way of defining the odds (aka the probability) is to calculate the utility of choosing over the sum of utilities. The equation is written like this:
