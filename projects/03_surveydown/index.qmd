...
[<i class="bi bi-browser-safari"></i> Website](https://surveydown.org){.btn .btn-primary .mx-1}
[<i class="bi bi-github"></i> GitHub](https://github.com/surveydown-dev/surveydown){.btn .btn-primary .mx-1}
[<i class="bi bi-award"></i> Award](https://ospo.gwu.edu/2024-student-open-source-award-winners){.btn .btn-primary .mx-1}
:::
...
[<i class="bi bi-journal-bookmark-fill"></i> Journal Webpage](https://journals.plos.org/plosone/article?id=10.1371/journal.pone.0331002){.btn .btn-outline-primary .mx-1}
