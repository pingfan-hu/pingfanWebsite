...
Or you can copy the following citation texts:

```{.default}
Hu P, Bunea B, Helveston JP (2025) surveydown: An open-source, markdown-based platform for programmable and reproducible surveys. PLoS One 20(8): e0331002. https://doi.org/10.1371/journal.pone.0331002
```
